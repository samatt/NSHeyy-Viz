function App(){
  ...
  layouts.onChange(function(value) {
    ...
    //
    //   r = f4.add(params.layoutParams,"circMin",5,20).step(1);
    //   r.onFinishChange(function(value){myNetwork.updateParams("true:circMin:"+value);});
    //
    //   r =f4.add(params.layoutParams,"circMax",5,20).step(1);
  ...
  function Params() {
    ...
    this.test = " s";
    this.layoutParams = {
      routerColor: colorbrewer.Set3[12][Math.floor((Math.random() * 12) + 1)],//Set3[12][1],
      clientColor: colorbrewer.Set3[12][Math.floor((Math.random() * 12) + 1)],//Set3[12][3],
      ...
      friction: 0.5,
      charge: -150,
      minColor: colorbrewer.Set3[12][Math.floor((Math.random() * 12) + 1)],//.Reds[9][2],
      maxColor: colorbrewer.Set3[12][Math.floor((Math.random() * 12) + 1)],//.Set3[12][3],
      minConnections: 3,
      circMin : 4,
      circMax: 11
    };
